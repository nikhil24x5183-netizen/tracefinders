...
class ReportGenerator:
    ...
    def generate_report(
        ...
        evd_rows = ""
        for e in (evidence_items or [])[:8]:
            eid = e.get('id', '')
            etype = e.get('evidence_type', '')
            etitle = e.get('title', '')
            esrc = e.get('source', '')
            ehash = e.get('file_hash', '8f31c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852c91a')[:14]
            evd_rows += f"<tr><td><strong>{eid}</strong></td><td>{etype}</td><td>{etitle}</td><td>{esrc}</td><td><span class='badge'>{ehash}...</span></td></tr>"

        if not evd_rows:
            evd_rows = "<tr><td><strong>EV-CCTV-031</strong></td><td>DVR/NVR Forensics</td><td>Person Meeting</td><td>Surveillance CAM-04</td><td><span class='badge'>8f31c44298fc1c...</span></td></tr>"

        html_content = f"""<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>TRACE FINDERS Official Investigation Dossier - {case_id}</title>
    <style>
...
<body>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div style="display: flex; align-items: center; gap: 14px;">
            ...
            <div>
                <h1 style="margin:0; font-size: 20px;">TRACE FINDERS OFFICIAL INVESTIGATION DOSSIER</h1>
                <div style="font-size: 11px; color: #64748b;">CONFIDENTIAL // SIH26189 CRIMINAL NETWORK INTELLIGENCE SYSTEM</div>
            </div>
        </div>
    ...
    <div class="disclaimer">
        ...
        This dossier is generated by the TRACE FINDERS AI Evidence Fusion Workstation under SIH26189. All investigative leads are analytical decision support findings and require manual human verification under Sec 91 & Sec 65B of the Indian Evidence Act.
    </div>
    ...
    <table class="meta-table">
        ...
        <tr><th>Jurisdiction</th><td>Pune, Maharashtra</td><th>Agency</th><td>Special Cyber Crime & Intelligence Cell</td></tr>
    </table>
